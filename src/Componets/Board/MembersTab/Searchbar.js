...
//    })
 ...
 const userList = filteredData.map((user, id) => (
    <div className="flex bg= bg-white rounded-lg justify-between resultrow">
    ...
    <button   className = "p-5" onClick= {()=> handleClick(user)}><img  src={plusIcon} className = "w-[12px]" /></button>
    </div>
      ));
...
<form class="flex items-center">   
    ...
    <div class="relative w-full">
        ...
        <input  onChange = {handleChange} type="text" id="simple-search" class=" border bg-white border-gray-300 text-gray-900 text-sm rounded-lg  block w-full pl-10 p-2.5 outline-none" placeholder="Add Member" required=""/>
    </div>
</form>
